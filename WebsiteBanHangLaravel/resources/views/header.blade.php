			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href="{{url('lien-he')}}"><i class="fa fa-home"></i> 90-92 Lê Thị Riêng, Bến Thành, Quận 1</a></li>
						<li><a href="{{url('lien-he')}}"><i class="fa fa-phone"></i> 0163 296 7751</a></li>
					</ul>
				</div>
					...
					<div class="beta-comp">
						<div class="cart">
							...
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng( 
								@if(Session::has('cart')) {{$cart->totalQty}}
								@else Trống)
								@endif
								...
								<div class="cart-item">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											@if($product['item']['promotion_price']) {{number_format($product['item']['promotion_price'])}}
											@else
