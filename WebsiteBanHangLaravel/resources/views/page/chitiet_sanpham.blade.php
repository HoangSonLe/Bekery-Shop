			...
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="beta-products-list">
						...
						<br>
						<div class="row">
							@foreach($sanpham_tuongtu as $sanpham)
							<div class="col-sm-4">
								<div class="single-item">
									<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>

									<div class="single-item-header">
										<a href="#"><img width="230px" height="240px" src="image/product/{{$sanpham->image}}" alt=""></a>
									</div>
									<div class="single-item-body">
									...
									<div class="single-item-caption">
										...
										<a class="beta-btn primary" href="chi-tiet-san-pham/{{$sanpham->id}}">Xem chi tiết <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
										<br>
										<br>
									</div>
